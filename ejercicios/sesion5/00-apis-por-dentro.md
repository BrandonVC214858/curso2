...
## 3. Los códigos de estado son el idioma común
...
## 5. `routes/api.php`, el archivo que no existe
...
## 6. El API Resource es el componente Blade de la API
...
## 8. Cómo se identifica un programa
...
## 9. El encabezado que explica el error más común
...
## 11. Tres agujeros propios de una API
...
## 12. Por qué el navegador no puede llamar a cualquier API
...
- **JSON**: el formato de texto en el que viajan los datos.
